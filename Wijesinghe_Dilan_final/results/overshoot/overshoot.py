...
python3 base.py
Then load up Coppelia sim and insert ' overshoot.csv'
"""
...
with open('overshoot.log', 'wt') as f:
    sys.stdout = f
    ...
    np.savetxt("overshoot.csv", real_config, delimiter=',')
    np.savetxt("overshoot_err.csv", X_err, delimiter=',')
